...
- For the current Program 1 launch Grade 12 cohort's first real Phase, non-empty **Historical Holistic Notes** take precedence over the Student Profile; Students without any substantive migrated answer see their Profile instead of an empty historical record
- For those current Program 1 Grade 12 Students, **Historical Holistic Notes** remain the fallback context in later Phases until a newer applicable Phase has submitted Post-Session Notes; EMRS does not use the Program 1 historical import
