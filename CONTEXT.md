...
- V1 has no flagged-Profile state in the Mentor experience; an existing successful Profile remains visible until a successful Admin-requested regeneration replaces it, and generated text remains non-editable
...
- V1 Phase opening and return-to-Locked changes are immediate manual Admin actions with confirmation and actor/time audit; scheduled Phase opening is out of scope
