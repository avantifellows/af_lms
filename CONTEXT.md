...
- V1 Student Profile generation sends the complete questionnaire answer set to the approved OpenRouter model but excludes the Student's name, User ID, Student ID, School, and other direct LMS identifiers from the external payload
