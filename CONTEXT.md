...
- For those launch Grade 12 Students, **Historical Holistic Notes** remain the fallback context in later Phases until a newer applicable Phase has submitted Post-Session Notes; the guarded Program 1 import does not migrate EMRS history
