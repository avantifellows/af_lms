...
- Student Addition #197 revision is in progress. The one-by-one NVS add now uses PEN and the revised canonical fields, permits scoped writers without a Centre mapping, and includes PEN in roster identity display; bulk, Edit, and dropout revisions remain separate slices.
