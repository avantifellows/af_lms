...
- The remaining NVS Phone Registration work is the coordinated DB Service deployment and the manual Portal smoke gate; the AF LMS activation and regression coverage are shipped in slice #303. Post-approval backfill remains a later coordinated approval release. See `context/student-addition.md`, `docs/nvs-phone-registration-release.md`, and ADR 0006.
