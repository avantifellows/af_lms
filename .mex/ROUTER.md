...
- Student Addition #155 is implemented in AF LMS for NVS one-by-one add, bulk upload, existing-student edit, and dropout hardening; NVS school eligibility for these flows now comes only from active centre mappings, with final merge review still pending.
