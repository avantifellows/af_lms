  ...
  return (
    <main className="min-h-screen bg-bg">
      <div className="px-4 sm:px-6 md:px-16 lg:px-32 xl:px-64 2xl:px-96 py-6 md:py-8">
        <div className="flex justify-between items-center mb-6 border-b-4 border-border-accent pb-4">
          <h1 className="text-2xl font-bold text-text-primary uppercase tracking-tight">All Visits</h1>
          ...
          <form method="get" className="mb-6 bg-bg-card border border-border p-4">
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex items-end gap-2">
                <button
                  type="submit"
                  className="inline-flex items-center px-4 py-2 text-sm font-bold uppercase tracking-wide text-text-on-accent bg-accent hover:bg-accent-hover"
                >
                  Apply Filters
                </button>
                <Link
                  href="/visits"
                  className="inline-flex items-center px-4 py-2 text-sm font-bold uppercase tracking-wide text-text-secondary bg-bg-card-alt border border-border hover:bg-hover-bg"
                >
                  Reset
                </Link>
              </div>
